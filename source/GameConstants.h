...
const int SOUND_PLAYER_SPRAY = 1;
const int SOUND_PED_DIE = 2;
const int SOUND_PED_HURT = 3;
const int SOUND_ZOMBIE_ATTACK = 4;
const int SOUND_VEHICLE_DIE = 5;
const int SOUND_VEHICLE_HURT = 6;
const int SOUND_VEHICLE_CRASH = 7;
const int SOUND_OIL_SLICK = 8;
const int SOUND_GOT_GOODIE = 9;
const int SOUND_GOT_SOUL = 10;
const int SOUND_FINISHED_LEVEL = 11;
const int SOUND_THEME = 12;
